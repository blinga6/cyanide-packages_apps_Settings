...
package com.android.settings.vrtoxin.util;
...
import com.android.settings.vrtoxin.util.ShortcutPickerHelper.AppExpandableAdapter.GroupInfo;
...
public class ShortcutPickerHelper {
    ...
    private void processShortcut(Intent intent,
        ...
        if (applicationName != null && applicationName.equals(shortcutName)) {
            ...
            Builder builder = new Builder(mParent, com.android.internal.R.style.Theme_Material_DayNight_Dialog_Alert);
