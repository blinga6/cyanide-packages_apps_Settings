...
public class EntryEditDialogFragment extends DialogFragment
    ...
    private Switch mBlockCalls;
    private Switch mBlockMessages;
    ...
    private View createDialogView(long id, Bundle savedState) {
        ...
        mBlockCalls = (Switch) view.findViewById(R.id.incoming_calls);
        mBlockMessages = (Switch) view.findViewById(R.id.incoming_messages);
