...
public class AppOpsState {
    ...
    public AppOpsState(Context context) {
        ...
        mOpSummaries = context.getResources().getTextArray(R.array.app_ops_summaries_vrtoxin);
        mOpLabels = context.getResources().getTextArray(R.array.app_ops_labels_vrtoxin);
    }
